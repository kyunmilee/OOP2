...
int main() {
    ...
    int withdrawAmount;
    cin >> withdrawAmount;
    cout << "subtracting " << withdrawAmount << " to account1 balance";
    account1.withdraw(withdrawAmount);

    cout << "\n\nacccount1: " << account1.getName() << " balance is $" << account1.getBalance();
    cout << "\naccount2: " << account2.getName() << " balance is $" << account2.getBalance();

    cout << "\n\nEnter withdraw amount for account2: ";
    cin >> withdrawAmount;
    cout << "subtracting " << withdrawAmount << " to account2 balance";
